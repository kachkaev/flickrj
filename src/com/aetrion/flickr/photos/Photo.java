...
public class Photo {
	 ...
	 * @deprecated attribute no longer available when doing
	 *             flickr.photos.getInfo request. However, flickr.photos.search
	 *             with views in extras still returns the value.
	 */
	public int getViews() {
		return views;
	}
	 ...
	 * @see <a
	 *      href="http://www.ibm.com/developerworks/library/j-dyn0603/">http://www.ibm.com/developerworks/library/j-dyn0603/</a>
	 */
	@Override
						...
						if (res != null && resTest != null) {
							...
							for (int j = 0; j < col.size(); j++) {
								...
								if (tobj1 instanceof Tag) {
									...
									System.out.println("Photo unhandled object: "
											+ tobj1.getClass().getName());
								}
							}
						} else {
							if (res == null && resTest != null)
			...
			if (m.find() && !method[i].getName().equals("getClass")) {
				...
				if (res != null) {
					if (res instanceof Boolean) {
						...
						System.out.println("Photo hashCode unrecognised object: "
